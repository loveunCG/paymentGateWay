        ...
        <section class="content-header">
            <div class="col-sm-12" style="margin-bottom: 15px;">
                <span style="margin-left: -12px;">
                    <b style="font-size: 25px;">Inbox</b> (<small><strong><?php echo $unread_mail; ?></strong></small>)
                </span>        
            </div>
        </section>
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="<?php echo base_url() ?>employee/dashboard/delete_inbox_mail" >
                    <!-- Main content -->
