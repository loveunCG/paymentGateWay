                ...
                <div class="panel-body">
                    ...
                    ?>" method="post" class="form-horizontal form-groups-bordered">
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo $this->language->from_body()[10][0] ?> </label>
                        ...
                        <div id="add_new" class="margin"> 
                            <?php if (!empty($designation_info)): foreach ($designation_info as $v_designation) : ?>
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-3 control-label"><?php echo $this->language->from_body()[10][1] ?> </label>
                        ...
                        <!--//@pank 13-8-2016 START HERE -->
                         <div class="form-group">
                            <label for="field-1" class="col-sm-3 control-label"><?php echo "Quickbooks_classes";//$this->language->from_body()[16][0] ?><!--<span class="required">*</span>--></label>

                            <div class="col-sm-5">
								 
                                <select name="quickbooks_class_id" class="form-control">
                                    <option value="" >Select Quickbooks_classes</option>  
                                                                  
                                    <?php  
									if(!empty($quickbooks_classes_info)): 
										foreach ($quickbooks_classes_info as $quickbooks_classes): ?>
											<option <?php echo (isset($department_info->quickbooks_class_id) && $quickbooks_classes->quickbooks_class_id == $department_info->quickbooks_class_id) ? 'selected ' : '' ?> value="<?php echo $quickbooks_classes->quickbooks_class_id; ?>" > <?php echo $quickbooks_classes->quickbooks_class_name ;  ?>
											</option>
									<?php
										endforeach;
									endif;
    ...
    $(document).ready(function() {
        ...
        $("#add_more").click(function() {
            if (maxAppend >= 9)
            {
                ...
                <label for="field-1" class="col-sm-3 control-label">Add Designations</label>\n\
