                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 form-groups-bordered">
								...
								<div class="form-group hide" id="div_monthly_payment_date" >
								...
								<div class="form-group hide" id="div_bi_monthly_payment_date">
								...
								<div class="form-group hide" id="div_two_weekly_payment_date">
                                ...
                                <div class="form-group hide" id="div_weekly_payment_date">
												...
												<input type="hidden" name="total_holiday_hour[<?php echo $v_payment_history->employee_id?>]" value="<?php echo $holiday_salary ;?>">	
																...
																if(is_array($v_payment_history->global_allowance))
																{
																	...
																	foreach($v_payment_history->global_allowance as $gb_alw)
																	{
																		if($gb_alw != "")
																		{
																			...
																			if(isset($dd[2]))
																			{
																				if($databasePaymentFrequency!=3 && $dd[2]=='fix')
																				{
													...
													<?php 
														...
														if(isset($new_globle_allownces_array)){
															...
															echo '<a href="#" id="age" data-toggle="tooltip" title="'.$global_allowance_string.'" p_id="' . $v_payment_history_salary_payment_id . '" class="more">' . $currency . ' ' . number_format($allowance, 2) . '</a>';
														}
														//ends
													?>
													</td>
													 ...
													 //
															...
															if(isset($v_payment_history->payroll_tax_deduction))
															{
                                                               ...
                                                               // echo '<a href="#" id="age" data-toggle="tooltip" title="Total Leave Days='.$v_payment_history->no_of_total_leave_hours.' And leave deduction=' . $leave_deduction . $this->payroll->$no_of_leave_day . '" p_id="' . $v_payment_history->salary_payment_id . '" class="more">' . $currency . ' ' . number_format($leave_deduction, 2) . '</a>
                                                                ...
                                                                <a href="#" id="age" data-toggle="tooltip" title="' . $global_deduction_string . '" p_id="' . $v_payment_history_salary_payment_id . '" class="more" >' . $currency . ' ' . number_format($deduction, 2) . '</a>';
