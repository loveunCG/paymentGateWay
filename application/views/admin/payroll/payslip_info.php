	...
	<?php  foreach($employee_salary_info as $employee_salary_info) {
      ...
      <div class="payment_receipt">
        ...
        <div style="width: 100%;">            
            ...
            <div align="center">
                 <div class="tbl1" style="margin-top:30px">
                ...
                <div class="tbl2" style="margin-top:30px">
                    <table >
                        <tr>
			...
			<div class="tbl3" style="margin-top:10px">
			...
			<!-- ************** Total Working Salary Details Start  **************-->
				...
				<table class="tbl_total"  style="float:left;border-bottom: 1px solid;">
					...
					//echo "<".$employee_salary_info->total_working_salary.">total_overtime_salary="."<".$employee_salary_info->total_overtime_salary.">";
					//echo $working_salary;
