...
<?php echo message_box('error'); ?>
    ...
    <div class="col-sm-9">
        <h4 class="pull-left"><?php echo anchor('admin/payroll/add_payroll_tax/', '<i class="fa fa-plus"></i>'.  $this->language->from_body()[10][22] ); //echo "<pre>";print_r($this->language->form_heading())?></h4>        
    </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <strong><i class="fa fa-minus-square"></i> <?php echo $this->language->form_heading()[35] ?></strong>
                                    </div>
                ...
                <tbody>
                    <?php $i=1;foreach($funds as $fund){ ?>
                            <tr>
                                ...
                                <td>Class <?php echo $fund['business_class'];?></td>
                                <td><?php echo btn_edit('admin/payroll/add_payroll_tax/'.$fund['id']); ?>  <?php echo btn_delete('admin/payroll/delete_payroll_tax/' . $fund['id']); ?> </td>
                            </tr>                
                        <?php $i++; } ?>
                </tbody>
            </table>
