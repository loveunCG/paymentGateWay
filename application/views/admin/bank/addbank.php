        ...
        <div class="panel panel-default" data-collapsed="0">
            <div class="panel-heading">
                <div class="panel-title">
                    <strong><?php echo $this->language->form_heading()[42] ?></strong>
                </div>                
            </div>
            <div class="panel-body">

                <form role="form" id="general_settings" enctype="multipart/form-data" onsubmit="return validation(this)" action="<?php echo base_url(); ?>admin/bank/save_cinfo/<?php if (!empty($ginfo)) echo $ginfo->id; ?>" method="post" class="form-horizontal form-groups-bordered">
                <input type="hidden" name="pay_type_status"  class="form-control" id="field-1" value="2"/>
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo $this->language->from_body()[2][2] ?> <span class="required"> *</span></label>

                        <div class="col-sm-5">
                            <input type="text" name="channel_name"  class="form-control" id="field-1" value="<?php if (!empty($ginfo)) echo $ginfo->channel_name; ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="field-1" class="col-sm-3 control-label"><?php echo $this->language->from_body()[57][68] ?> <span class="required"> *</span></label>

                        <div class="col-sm-5">
                            <input type="text" name="channel_code"  class="form-control" id="field-1" value="<?php if (!empty($ginfo)) echo $ginfo->channel_code; ?>"/>
                        </div>
                    </div>                                         
                    <div class="form-group">
