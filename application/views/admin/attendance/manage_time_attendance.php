                        ...
                        <div class="form-group margin">
                            ...
                            <div class="col-md-6">
                                <select name="type" class="form-control">
                                    ...
                                    <option value="POS">CounterPoint POS</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <form id="form" action="<?php echo base_url() ?>admin/attendance/manage_attendance" method="post"  enctype="multipart/form-data" class="form-horizontal">
                                <div class="panel_controls">                         
                                    <div class="form-group margin">
                                        <label class="col-sm-3 control-label">Start Date<?php //echo $this->language->from_body()[15][0] ?> <span class="required">*</span></label>
									 ...
									 <div class="form-group margin">
                                        <label class="col-sm-3 control-label">End Date<?php //echo $this->language->from_body()[15][0] ?> <span class="required">*</span></label>

                                        <div class="col-sm-5">
                                            <div class="input-group">
                                                <input type="text" name="endDate" id="endDate"  placeholder="Enter Day"  required class="form-control datepicker" value="<?php
                                                if (!empty($date)) {
                                                    echo $date;
                                                }
                                                ?>" data-format="dd-mm-yyyy">
									...
									<div class="form-group margin">
                                        <label class="col-sm-3 control-label">Select In Time: </label>
									...
									<div class="form-group margin">
                                        <label class="col-sm-3 control-label">Select Out Time: </label>
                                    ...
                                    <div class="form-group">
                                        <label for="field-1" class="col-sm-3 control-label"><?php echo $this->language->from_body()[15][1] ?> </label>

                                        <div class="col-sm-5"> <!--@Harshita 5August Ajax Based  change onchange function here..... -->
                                            <select name="department_id_not_required" id="department" onchange="get_employee_by_designations_id(this.value)" class="form-control">
