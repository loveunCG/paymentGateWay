				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="panel-title">
							<form role="form" id="general_settings" enctype="multipart/form-data" onsubmit="return validation()" action="<?php echo base_url(); ?>admin/finance/success_withdrawlist"
								...
								<div class="row">
									<div class="form-group col-lg-3">
										...
										<div class="input-group col-md-7">
											...
											<input type="text" class="form-control" id="datepicker" name="start_date" value="<?php if(!empty($start_date)) echo $start_date; ?>">
										</div>
									</div>
									<div class="form-group col-lg-3">
										...
										<div class="input-group col-md-7">
											...
											<input type="text" class="form-control" id="datepicker1" name="end_date" value="<?php if(!empty($end_date)) echo $end_date; ?>">
										</div>
									...
									<div class="form-group col-lg-3">
										...
										<div class="input-group col-md-7">
											...
											<input type="text" class="form-control" name="employee_id" style="border-radius: 4px;" value="<?php if(!empty($employee_id)) echo $employee_id; ?>">
										</div>
				...
				<table class="table table-bordered table-hover" id="dataTables-example">
					...
					<thead>
						<tr>
							...
							<th>
								<?php echo $this->language->from_body()[58][5] ?>
							</th>
							<th>代理ID</th>
							<th>
								<?php echo $this->language->from_body()[58][7] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[58][8] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[2][43] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[57][6] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[57][8] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[2][49] ?>
							</th>
							<th>
								<?php echo $this->language->from_body()[57][7] ?>
							</th>
							<th>状态</th>
