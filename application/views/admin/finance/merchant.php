                        ...
                        <div class="wrap-fpanel">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <form role="form" id="general_settings" enctype="multipart/form-data" onsubmit="return validation(this)" action="<?php echo base_url(); ?>admin/finance/merchant" method="post" class="form-horizontal form-groups-bordered">
                                    <div class="row">
...
<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 提交总金额: <?php if(!empty($total)) echo $total; ?>元</strong>
							<?php } else{ ?>
							<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 提交总金额: 0.00元</strong>
							<?php } ?>
                                    <button style="float: right;" class="btn-print" type="button" data-toggle="tooltip" title="" onclick="employee_list('employee_list')" data-original-title="Print" aria-describedby="tooltip478896"><a href="<?php echo base_url(); ?>admin/finance/merchant" class="btn btn-primary btn-xs" title="" data-toggle="tooltip" data-placement="top" onclick="printDiv(" printablearea")"="" data-original-title="Print"><span class="glyphicon glyphicon-print"></span></a></button>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover" id="dataTables-example" >
									<thead>
										<tr>
											...
											<th><?php echo $this->language->from_body()[12][31] ?></th>
	                             ...
	                             <form role="form" id="set_submin" enctype="multipart/form-data" onsubmit="return validation(this)" action="<?php echo base_url(); ?>admin/finance/merchant_all/" method="post" class="form-horizontal form-groups-bordered">									
									<tbody>
										<?php
											//echo "<pre>";										
											//print_r($cinfo);
											...
											$i=1;foreach($cinfo as $fund)
											{
												?>
												<tr>
													<td><input class="child_present" type="checkbox" name="selected_send_id[]" value="<?php echo $fund['emp_id']; ?>"/></td>													
													<td>														
														<b><?php echo $fund['emp_id']; ?></b>													
													</td>                     
													<td>
														<b><?php echo $fund['usr_bank_num']; ?></b>
													</td>
													<td>
														<b>																	<?php if ($fund['usr_amount']) {
															echo $fund['usr_amount'];
													...
													<td>
														...
														<?php if ($fund['jisuan_jine'] =="") {
															echo 0;
														}else{ echo $fund['jisuan_jine']; }
														?>
														
													</td>
													<td>
														<b><?php echo $fund['group_fee']; ?>%</b>
