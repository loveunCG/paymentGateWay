...
<?php echo message_box('error'); ?>
        ...
        <div class="col-md-12">
    <form method="post" action="<?php echo base_url() ?>admin/finance/agent_withdrawlist" >
...
<strong><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 提交总金额: <?php if(!empty($total)) echo $total; ?>元</strong>
							...
							<?php } ?>
                                ...
                                <!-- Table -->
                            <form method="post" action="<?php echo base_url() ?>admin/finance/accept_agent_withdraw" >                                
									...
									<tbody>
										<?php
											...
											$i=1;foreach($cinfo as $fund)
											{
												?>
												<tr>
													<td><input class="child_present" type="checkbox" name="selected_send_id[]" value="<?php echo $fund['number']; ?>"/ ></td>
													<td>														
                                                    ...
                                                    <td>
                                                        <?php if ($fund['time_state']==1) {
                                                               echo '<span class="label label-success">正常</span>';
                                                                } elseif($fund['time_state']==0){
													...
													<td>
													<?php if($fund['pay_state']!=1){ ?>
													<?php echo btn_submit('admin/finance/accept_agent_withdraw/'.$fund['number']); ?> <br><br> <?php echo btn_reject('admin/finance/reject_agent_view/' . $fund['number']); ?>
													<?php } else{ ?>
