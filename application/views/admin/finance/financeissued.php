...
<?php echo message_box('error'); ?>
        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                <div>
                        <div class="wrap-fpanel"> <form method="post" action="<?php echo base_url() ?>admin/finance/Issued" >
                           ...
                           <input type="radio" name="bank_status" value="2" id="usr_status" > 银行卡&nbsp;
                            <input type="radio" name="bank_status" value="3" id="usr_status" > 支付宝&nbsp;
                            <input type="radio" name="bank_status" value="4" id="usr_status" > 财付通
                             <?php   } ?>		                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" id="sbtn" class="btn btn-primary" id="i_submit" >开始查询</button><br><br>
		                             <?php  if($total!=null){ ?>
...
<strong><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 提交总金额: <?php if(!empty($total)) echo $total; ?>元</strong>
							...
							<?php } ?>
                                  ...
                                  <form method="post" action="<?php echo base_url() ?>admin/finance/send_finance" >
										...
										<?php
											...
											$i=1;foreach($cinfo as $fund)
											{
												...
												<tr>
													...
													<td><?php  echo btn_submit('admin/finance/request_accept/'.$fund['id']); ?> <br><br>
