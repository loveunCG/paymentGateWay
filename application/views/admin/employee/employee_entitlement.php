            ...
            <div class="panel panel-default" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title">
                        <strong>Add New Entitlement to Employee</strong>
                    </div>
                </div>
				...
				<label for="field-1" class="col-sm-3 control-label">Leave Type<span class="required">*</span></label>
                        ...
                        <select name="leave_category_id" class="form-control" >
                           ...
                           <?php if (!empty($all_leave_category_info)): ?>
                                            <?php foreach ($all_leave_category_info as $v_category) : ?>
                                                <option value="<?php echo $v_category->leave_category_id; ?>" 
                                                <?php
                                                if (!empty($entitlement_info->leave_category_id)) {
                                                    echo $v_category->leave_category_id == $entitlement_info->leave_category_id ? 'selected' : '';
                                                }
							 ...
							 <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Leave Periods<span class="required"> *</span></label>

                                <div class="col-sm-5">
                                    <input type="text" name="leave_periods"class="form-control years"  value="<?php
                                    if (!empty($entitlement_info->leave_periods)) {
                                        echo $entitlement_info->leave_periods;
                                    }
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label"> Leave Days<span class="required">*</span></label>

                                <div class="col-sm-5">
                                    <input type="text" name="leave_days" class="form-control" value="<?php
                                    if (!empty($entitlement_info->leave_days)) {
                                        echo $entitlement_info->leave_days;
                                    }
                                    ?>" />
                                </div>
                            </div>
