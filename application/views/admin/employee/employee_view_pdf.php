        ...
        <div style="width: 100%; margin-top: 55px;">
            ...
            <div >
                ...
                <table style="width: 100%; margin-top: 20px; padding: 10px 0;">
				 ...
				 <br />
				 <div style="width: 100%; background: #E3E3E3;padding: 1px 0px 1px 10px; color: black; vertical-align: middle; ">
                    <p style="margin-left: 10px; font-size: 15px; font-weight: lighter;"><strong>Employee Salary Details</strong></p>
                </div>            
                <table style="width: 100%; margin-top: 20px; padding: 10px 0;">
                    <tr>
                        <td>
                            <table style="font-size: 13px;width: 100%">
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Salary Type :</strong></td>
                                ...
                                <tr>
                                    <td style="text-align: right"><strong>Basic Salary or Rate/Hour :</strong></td>

                                    <td>&nbsp;<?php echo "$employee_info->basic_salary"; ?></td>
                                </tr>                                
                                <tr>
                                    <td style="text-align: right"><strong>Job Sector :</strong></td>
								...
								<tr>
                                    <td style="text-align: right"><strong>Payment Frequency :</strong></td>
