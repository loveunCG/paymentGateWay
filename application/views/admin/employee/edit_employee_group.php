                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <strong><i class="fa fa-minus-square"></i>  编辑商户组
                            </strong>
                        </div>
                                              ...
                                              <select name="channel_online" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==1) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_online ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_alipay" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==3) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_alipay ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_tenpay" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==4) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_tenpay ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_weixin" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==5) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_weixin ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_wapalipay" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==6) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_wapalipay ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_wapweixin" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==9) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_wapweixin ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                              ...
                                              <select name="channel_daifu" class="form-control col-sm-5" aria-required="true" aria-invalid="false">
                                                ...
                                                foreach ($channel_info as $v_fields) :                                  
                                                    if ($v_fields->channel_type==10) {                                                           
                                                        ?>
                                                        <option value="<?php echo $v_fields->id?>" <?php if (!empty($ginfo)) echo $v_fields->id == $ginfo->channel_daifu ? 'selected' : '' ?>><?php echo $v_fields->channel_name; ?></option>
                                                        <?php
                                                        }                                  
                                                endforeach;
                                                ?>
                                ...
                                <div class="tab-pane fade" id="amount">
                                    ...
                                    <p>
                                        ...
                                        <div class="form-group">                  <!-- List  of days -->                   
                                         ...
                                         <span class="required"> </span></label>                          
                                                <label class="col-sm-1 ">
                                                    <input  type="checkbox" name="user_limit_set" value="<?php if (!empty($ginfo)) echo $ginfo->user_limit_set; ?>" 
                                                            <?php
                                                    ...
                                                    <span>
                                                    <?php
                                                        if (!empty($ginfo) && $ginfo->user_limit_set == 0) {  ?>
                                                    <input  type="hidden" name="user_limit_set" value="<?php echo 1 ?>"/>
                                                    <?php  } ?>
                                                    启用</span>
                                                </label>
                                        </div>                                                                                                                                                                                                                                         
