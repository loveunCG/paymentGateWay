                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <strong><i class="fa fa-minus-square"></i> 微信通道设置</strong>
                                    </div>
										...
										<?php
											...
											$i=1;foreach($cinfo as $fund)
											{
												...
												<tr>
													...
													<td><?php echo btn_edit('admin/gateway/view_channel/'.$fund['num'].'/5'); ?>  <?php echo btn_delete('admin/gateway/delete_gateway/' . $fund['num']); ?> </td>
												</tr>                
											<?php } ?>
									</tbody>
								</table>
