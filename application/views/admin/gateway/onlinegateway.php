										...
										<?php
											...
											$i=1;foreach($cinfo as $fund)
											{
												...
												<tr>
													...
													<td><?php echo btn_view('admin/gateway/view_gateway/'.$fund['id']); ?> <?php echo btn_edit('admin/gateway/add_gateway/'.$fund['id']); ?>  <?php echo btn_delete('admin/gateway/delete_gateway/' . $fund['id']); ?> </td>
												</tr>                
											<?php } ?>
									</tbody>
								</table>
