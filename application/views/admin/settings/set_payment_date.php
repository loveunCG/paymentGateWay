                ...
                <div class="panel-body">
                    ...
                    <form id="set_working_days" action="<?php echo base_url(); ?>admin/settings/save_payment_date/<?php if (!empty($id)) { echo $id; } ?>" method="post"  class="form-horizontal form-groups-bordered"  onsubmit="return validation(this)">                                                           
                        <div class="form-group">
							...
							<div class="form-group">
                                    <label class="col-sm-3 control-label">Set Monthly Payment Date<span class="required">*</span></label>
                                    <div class="input-group col-sm-6">
                                        <select id="monthly_payment_date" name="monthly_payment_date" class="form-control">
											<option value="">Select</option>
											<?php for($k=1;$k<=30;$k++){?>
											<option <?php if (!empty($monthly_payment_date) && $monthly_payment_date==$k) { echo "selected";} ?> value="<?php echo $k; ?>"><?php echo $k; ?></option>
											<?php } ?>
										</select>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Set Bi-Monthly Payment Dates <span class="required">*</span></label>
                                    <div class="input-group col-sm-6">
                                       <?php /* <input type="text"  value="<?php
										...
										* */?>
										...
										<select id="bi_monthly_payment_date1" name="bi_monthly_payment_date1" class="form-control">
											<option value="">Select</option>
											<?php for($k=1;$k<=30;$k++){?>
											<option <?php if (!empty($bi_monthly_payment_date1) && $bi_monthly_payment_date1==$k ) { echo "selected='selected'";} ?> value="<?php echo $k; ?>"><?php echo $k; ?></option>
											<?php } ?>
										</select>
										
										<select id="bi_monthly_payment_date" name="bi_monthly_payment_date2" class="form-control">
											<option value="">Select</option>
											<?php for($k=1;$k<=30;$k++){?>
											<option <?php if (!empty($bi_monthly_payment_date2) && $bi_monthly_payment_date2==$k) { echo "selected='selected'";} ?> value="<?php echo $k; ?>"><?php echo $k; ?></option>
											<?php } ?>
										</select>
                                    </div>
                                </div>		
							...
							<div class="form-group">
                                    <label class="col-sm-3 control-label">Set Fortnightly Payment Dates<span class="required">*</span></label>
                                    <div class="input-group col-sm-6">
                                ...
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label">Next Fortnightly Payment Day<span class="required">*</span></label>
                                    <div class="input-group col-sm-6">
                                        ...
                                        ?>" class="form-control" id="sdate" name="next_payment_date" >
										<div class="input-group-addon">
											<i class="entypo-calendar"></i>
										</div>
									</div>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Set Weekly Payment Day <span class="required">*</span></label>
                                    <div class="input-group col-sm-6">
                                       <!-- <input type="text"  value="<?php
